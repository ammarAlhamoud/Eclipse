...
private Tilgungsplaner gewuenschterTilgungsplaner = null;
	...
	private void Berechnung_steuern()
		{do
			...
			System.out.println("			 fällige Zinsen im Jahe X wissen? 		 (2)");	
			System.out.println("			 fällige Tilgung im Jahe X wissen? 	 	 (3)");
			System.out.println("			 fällige Mittelabfluss im Jahe X wissen? (4)");
			...
			if (c_gewuenschteBerechnung >= 2 && c_gewuenschteBerechnung <= 4)
				{System.out.println("Das wievilte Jahr möchten Sie betrachten? (lfdNr eingeben!)");
	...
	private void Tilgungsplanung_durchführen()
		{do
			{System.out.println("Wollen Sie ein Fälligkeitsdarlehen? (f)");
			System.out.println(            "ein Ratendarlehen?       (r)");
			System.out.println("            ein Annuitäten?          (a)");
			System.out.println("sonst                                (e)");
