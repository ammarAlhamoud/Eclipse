...
public static void main(String[] args) 
	...
	do
		{System.out.println("Mit wie viel Paar von Karten möchten Sie spielen? ");
		do
			{z_paarKarten =ConsolReader.readInt();
			System.out.println("Sie dürfen nur bis 26 Paare eintragen! Nocheinmal." );
			}
	...
	private static void verdeckte_karte_drücken()
		{elemnte_posNr="       ";
		String druck_array = "[0]  |  ";
		for (int j=0 ; j<zweite_dimesion_karte; j++)
			{elemnte_posNr +="["+j+"]";		
	...
	private static void erfölgreiche_Versuch()
		...
		do
			...
			if (karte1 == karte2)	
				...
				verdeckte_karte_drücken();
				System.out.println("erfölgreiche Versuchen : "+ erfölg_Versuch + " von " + z_Versuch);
				}
			else 
				{System.out.println("kein Glück!, versuchen Sie noch einmal.");
				}
			z_Versuch +=1;
			}
