...
public class DlgOperationswerk_Tester 
  {public static void main(String[] args) 
	{//SCHNELLTESTER
	 ...
	 do
	   {Auswahl(args);
	    System.out.println("Wünschen Sie eine erneute mathematische Anwendung? (j / n)");
   ...
   private static void Auswahl(String[] args)
     {char auswahl;
	   {// Ausgabe
	  	...
	  	System.out.println();
	  	System.out.println(" (1) Fakultät berechnen");
	  	System.out.println(" (2) Fläche unter einer linearen Funktion berechnen");
	  	...
	  	System.out.println(" (7) Gewichtsprüfer");
	  	System.out.println(" (8) Quadratzahl prüfen");	
	   }
   ...
   private static void Fakultaet_berechnen()
     {int eingabe, fakultaet;
	  System.out.println("Bitte Zahl zum Berechnen der Fakultät eingeben!");
      eingabe = ConsolReader.readInt();
      fakultaet = Operationswerk.get_Fakultaet_rekursiv(eingabe);
	  System.out.println("Die Fakultät von " + eingabe + " ist " + fakultaet);
     }
   ...
   private static void Flaeche_berechnen()
	...
	//  b = ConsolReader.readDouble();
	  System.out.println("x1 - von wo soll die Fläche berechnet werden");
	 // x1 = ConsolReader.readDouble();
	  System.out.println("x2 - bis wo soll die Fläche berechnet werden");
	 // x2 = ConsolReader.readDouble();
	  //flaeche = Operationswerk.get_Flaeche(m, b, x1, x2);
	  //System.out.println("Näherungswert der Fläche: " + flaeche);   
     }
