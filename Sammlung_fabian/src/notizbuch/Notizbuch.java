...
public class Notizbuch {
	...
	public void erweitere_notiz(int ss_notiznr, int ss_einfuegestelle, String ss_text) {
	...
	private int get_notiz_pos(int ss_notiznr) {
	...
	public String get_alle_notiznr() {
	...
	public String get_notizen_mit_suchtext(String ss_suchtext) {
	...
	public String get_notizen_mit_schlagwort(String ss_suchtext) {
	...
	public long get_alter(int ss_notiznr) {
